...
## 🚀 How to download and run read on Windows using Mac Catalyst
...
### Step 2: Download a macOS or iOS emulator for Windows
...
### Step 3: Visit the read releases page
...
- If using an iOS emulator like iPadian:  
  - Open iPadian.  
  - Use its app installation feature to add the `.ipa` file.

- If using a macOS virtual machine on VirtualBox or VMware:  
  - Start the macOS VM.  
